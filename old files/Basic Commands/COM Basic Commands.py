...
# Vissim = com.gencache.EnsureDispatch("Vissim.Vissim-32.9") # Vissim 9 - 32 bit
# Vissim = com.gencache.EnsureDispatch("Vissim.Vissim-64.9") # Vissim 9 - 64 bit
# Vissim = com.gencache.EnsureDispatch("Vissim.Vissim-32.10") # Vissim 10 - 32 bit
...
Path_of_COM_Basic_Commands_network = os.getcwd() #'C:\\Users\\Public\\Documents\\PTV Vision\\PTV Vissim 10\\Examples Training\\COM\\Basic Commands\\'

## Load a Vissim Network:
Filename                = os.path.join(Path_of_COM_Basic_Commands_network, 'COM Basic Commands.inpx')
flag_read_additionally  = False # you can read network(elements) additionally, in this case set "flag_read_additionally" to true
#Filename = 'COM Basic Commands.inpx'
print Filename

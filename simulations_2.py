from utils.sim_2 import generate_phase_times, run_simulation, printProgressBar
import sys
import time
import datetime
...
def main():
    ...
    flow_ratios = [[0.1,0.3,0.6],[0.6,0.3,0.1], [0.5,0.4,0.1], [0.35,0.35,0.3], [0.8, 0.1, 0.1],[0.2,0.4,0.4],[0.4,0.4,0.2],[0.3,0.6,0.1]]
    first_time = 1
                    ...
                    for scheme_number in range(2):
                        ...
                        if sim_number>last_checkpoint:
                            ...
                            if sim_number%102 == 0:
                                ...
                                close_vis = False
                            run_simulation(ct,phase_times,lost_time,ratios,first_time, 'second_intersection_jan28_4.csv',
